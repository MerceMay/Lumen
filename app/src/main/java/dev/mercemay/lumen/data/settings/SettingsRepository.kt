...
class SettingsRepository @Inject constructor(
    ...
    val speedTestConfig: Flow<SpeedTestConfig> = context.settingsDataStore.data.map { preferences ->
        SpeedTestConfig(
            ...
            maxDelayMillis = preferences[Keys.maxDelayMillis] ?: 500L,
            minDelayMillis = preferences[Keys.minDelayMillis] ?: 0L,
            maxLossRate = preferences[Keys.maxLossRate] ?: 0.2,
            minDownloadSpeedMbps = preferences[Keys.minDownloadSpeedMbps] ?: 5.0,
